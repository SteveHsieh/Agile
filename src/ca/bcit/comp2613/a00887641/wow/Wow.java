package ca.bcit.comp2613.a00887641.wow;
...
public class Wow {
	...
	public static void main(String[] args) throws DontHaveTheExpansionException {
		...
		System.out.println("The missing character's level is " + getLevelOfMissingCharacter());
	}
	...
	private static int getRandomLevel() {
		return rand.nextInt(86); // TODO is this right?
	}
